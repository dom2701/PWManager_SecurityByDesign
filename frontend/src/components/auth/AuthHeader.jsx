	...
	return (
		<header className="w-full py-4 px-6 flex items-center justify-between">
			<div className="flex items-center gap-3">
				<Link to={backHref || '/dashboard'} className="flex items-center">
				...
				{backHref && (
					<Link to={backHref} className="text-sm text-gray-600 dark:text-gray-300 ml-3 hover:underline">Zurück</Link>
				)}
			</div>
